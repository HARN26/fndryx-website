...
export default function Hero() {
  const scrollToFounderForge = () => {
    document
      .getElementById("founder-forge")
  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-steel-900">
      ...
      <div className="relative mx-auto flex max-w-5xl flex-col items-center px-6 pb-16 pt-28 text-center">
        ...
        <a
          href="#problem"
          className="mt-8 text-sm text-fire-400 hover:text-fire-300 rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-fire-400 focus-visible:ring-offset-2 focus-visible:ring-offset-steel-900"
        >
          Here&apos;s why ↓
        </a>
      </div>
