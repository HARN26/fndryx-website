...
1. **Build Ready + Investor Ready — Forged.** The obvious "fund it" companies. Rarer than the market behaves as if they are.
2. **Build Ready, not Investor Ready — Tempering.** Durable companies telling their story poorly, structured for the wrong round, or aimed at the wrong stage of capital. Usually the most fixable.
3. **Investor Ready, not Build Ready — Hot Iron.** Polished pitch, clean deck, weak fundamentals. The companies that raise — and then quietly stall.
4. **Neither — Ore.** Too early to fund, too unfinished to operate. The honest answer is usually "more time, more evidence."
...
*FNDRYx is the measurement infrastructure between founders and capital — built so merit, not pattern, sets price. If you are a founder wondering which kind of "ready" you actually are, that is exactly the question our Capital Readiness Assessment was built to answer.*

<div className="text-center my-12">
  <a
    href="https://assess.fndryx.io/"
    className="inline-block font-display font-semibold text-base uppercase tracking-[0.15em] text-fire-400 hover:text-fire-300 border-b border-fire-400 hover:border-fire-300 pb-1 transition-colors"
    target="_blank"
